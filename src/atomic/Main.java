...
public class Main {
    ...
    public static short SIMILAR = 1;
    public static short BY_HEIGHT = 2;
    public static final int masSize = 100_000;
    public static final int stringSizePlus = 3;
    public static AtomicInteger stop = new AtomicInteger(0);
    ;
    ...
    public static short byHeight(String s) {
